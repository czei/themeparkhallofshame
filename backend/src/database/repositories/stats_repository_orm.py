"""
Theme Park Downtime Tracker - Statistics Repository (ORM Version)
Provides data access layer for aggregate statistics tables using SQLAlchemy ORM.

MIGRATION NOTE
==============
This is a minimal ORM migration of stats_repository.py. Most query methods have been
migrated to modular query classes in database/queries/ and are NOT included here.
...
All other methods from the original stats_repository.py have been migrated to
modular query classes or are deprecated.
"""
...
class StatsRepository:
    ...
    Migration Note: This is a minimal implementation. Most query methods have been
