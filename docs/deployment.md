...
|---------------|---------|
| **This file** | Deployment procedures and troubleshooting |
| [architecture.md](architecture.md#system-architecture-diagram) | System architecture diagram and technology decisions |
