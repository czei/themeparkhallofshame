...
class TestHealthEndpoint:
    """Test health check endpoint - requires database."""
    ...
    def test_health_endpoint_returns_200_when_healthy(self):
        """GET /api/health should return 200 when all checks pass (integration test)."""
    ...
    def test_health_endpoint_returns_503_when_unhealthy(self):
        """GET /api/health should return 503 when database fails (integration test)."""
        # Requires database connection
        # Deferred to integration tests
        pass

    @pytest.mark.skip(reason="Requires database connection (integration test)")
    def test_health_endpoint_checks_database_connectivity(self):
        """GET /api/health should check database connectivity (integration test)."""
        # Requires database connection
        # Deferred to integration tests
        pass

    @pytest.mark.skip(reason="Requires database connection (integration test)")
    def test_health_endpoint_checks_data_freshness(self):
        """GET /api/health should check last data collection timestamp (integration test)."""
        # Requires database with ride_status_snapshots table
        # Deferred to integration tests
        pass

    @pytest.mark.skip(reason="Requires database connection (integration test)")
    def test_health_endpoint_checks_aggregation_status(self):
        """GET /api/health should check last aggregation status (integration test)."""
        # Requires database with aggregation_log table
        # Deferred to integration tests
        pass
